...
/**
 * Created by michaelnwani on 2/18/15.
 */
public class TranslateTask implements Runnable{
    ...
    private String doTranslate(String original, String from, String to)
    {
        ...
        try
        {
            ...
            Log.d(TAG, "------------------------- JSON OBJECT OUTPUT IS: " + jsonObject.toString());
            result = jsonObject.getJSONObject("responseData").getString("translatedText").replace("&#39;", "'").replace("&amp;", "&");
